      ...
      <div className="hero-content flex-col lg:flex-row-reverse lg:gap-12">
        <div className="w-1/2">
          ...
          <img
            ...
            className="max-w-xl rounded-full border-[16px] border-blue-400"
          />
        </div>
        <div>
          <h1 className="text-5xl font-bold">Md Arif Shahriar</h1>
          <p className="py-6">
            Hi, this is Arif — a Computer Science student passionate about MERN
            stack development and solving real-world problems through code. I
            build scalable web solutions across diverse domains. Fueled by
            innovation and strategic thinking, I’m on a mission to turn bold
            ideas into impactful digital experiences.
          </p>
          <div className="flex gap-6 pb-5">
            <a
              href="https://www.linkedin.com/in/md-arif-shahriar-sohan-4080321b2/"
              className="link text-4xl text-blue-700"
            >
              <FaLinkedin />
            </a>
            <a
              href="mailto:arsohan101@gmail.com"
              className="link text-4xl text-red-700"
            >
              <SiGmail />
            </a>
            <a href="https://github.com/ar-sohan" className="link text-4xl">
              <FaGithub />
            </a>
            <a
              href="https://www.facebook.com/arif.sohan.77/"
              className="link text-4xl text-blue-700"
            >
              <FaFacebook />
            </a>
            <a className="link text-4xl text-pink-500">
          ...
          >
            <button onClick={() =>
                (window.location.href = "https://youtu.be/wX5cSFr8TKs")
              }
            className="btn btn-soft bg-gray-300">Video Resume</button>
            <button
              onClick={() =>
                (window.location.href = "https://drive.google.com/file/d/1gdNLD6WWtZUTqqPD4ceTdxW3Lyj-_vFg/view?usp=drive_link")
              }
              className="btn btn-soft bg-gray-300"
            >
              Resume
            </button>
          </div>
